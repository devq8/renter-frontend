    ...
    <div class="relative bg-white dark:bg-gray-800">
      <div class="flex flex-col sm:flex-row sm:justify-around">
        <div class="h-screen w-72">
          <div class="flex items-center justify-start mx-4 mt-10">
          ...
          <nav class="mt-10 px-6 ">
            ...
            >
              ...
              <span class="mx-4 text-lg font-normal">Properties</span>
            ...
            >
              ...
              <span class="mx-4 text-lg font-normal">Contracts</span>
              <span class="flex-grow text-right"></span>
            </a>
            <a
              class="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-600 dark:text-gray-400 rounded-lg "
            ...
            >
              ...
              <span class="mx-4 text-lg font-normal">Invoices</span>
            ...
            >
              ...
              <span class="mx-4 text-lg font-normal">Tenants</span>
              <span class="flex-grow text-right"></span>
            </a>
          </nav>
